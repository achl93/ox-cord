...
export default class SongSearchResult extends Component {
  ...
  render() {
    return (
      ...
      <p class= "artist">{ this.props.song.artist } <Button bsClass='btn btn-sm btn-outline-success badge float-right addButton' onClick={()=>{this.onHandleClick()}}><i class="fa fa-plus" aria-hidden="true"></i></Button></p>
      </ListGroupItem>
    )
  }
