...
export default class Song extends Component {
  render() {
    return (
      ...
      <h6>{ this.props.song.name } <Button bsClass='btn btn-sm btn-outline-danger badge float-right' onClick={()=>{this.onHandleClick()}}><i class="fa fa-trash" aria-hidden="true"></i></Button></h6>
