...
class JoinRoom extends Component {
  ...
  render() {
    ...
    return (
      <div><button className="btn btn-outline-info btn-block m-1" onClick={this.sendToRoom}>{this.props.room_name} | <i className="fa fa-map-marker" aria-hidden="true"></i> {(this.props.distance * 1000).toFixed(2)}m</button></div>
    )
  }
}
